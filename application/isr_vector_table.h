...
#define PVD_IRQHandler                                                                             \
    Vector44 /**< PVD through EXTI Line                                                            \
                  detect.                    */
#define TAMP_STAMP_IRQHandler                                                                      \
    Vector48                             /**< Tamper and TimeStamp                                 \
                                              through EXTI Line.         */
...
#define TIM1_TRG_COM_IRQHandler                                                                    \
    VectorA8                          /**< TIM1 Trigger and                                        \
                                           Commutation.               */
...
#define ETH_WKUP_IRQHandler                                                                        \
    Vector138                               /**< Ethernet Wakeup through                           \
                                                 EXTI line.                 */
...
#define OTG_HS_WKUP_IRQHandler                                                                     \
    Vector170                         /**< USB OTG HS Wakeup through                               \
                                           EXTI line.                 */
