                             ...
                             void (*reply_func)(unsigned char* data, unsigned int len))
{
    ...
    if (packet_id == COMM_EXT_NRF_PRESENT || packet_id == COMM_EXT_NRF_ESB_RX_DATA)
    {
    ...
    case COMM_GET_VALUES_SELECTIVE: {
        ...
        {
            buffer_append_float32(send_buffer, mc_interface_read_reset_avg_motor_current(), 1e2,
                                  &ind);
        }
        if (mask & ((uint32_t)1 << 3))
        {
            buffer_append_float32(send_buffer, mc_interface_read_reset_avg_input_current(), 1e2,
                                  &ind);
        }
        ...
        {
            buffer_append_float16(send_buffer, mc_interface_get_input_voltage_filtered(), 1e1,
                                  &ind);
        }
        ...
        {
            buffer_append_float32(send_buffer, mc_interface_get_amp_hours_charged(false), 1e4,
                                  &ind);
        }
        ...
        {
            buffer_append_float32(send_buffer, mc_interface_get_watt_hours_charged(false), 1e4,
                                  &ind);
        }
    ...
    case COMM_GET_DECODED_PPM: {
        ...
        buffer_append_int32(send_buffer, (int32_t)(servodec_get_last_pulse_len(0) * 1000000.0),
                            &ind);
        reply_func(send_buffer, ind);
    }
    break;
    ...
    case COMM_GET_DECODED_CHUK: {
        ...
        buffer_append_int32(send_buffer, (int32_t)(app_nunchuk_get_decoded_chuk() * 1000000.0),
                            &ind);
        reply_func(send_buffer, ind);
    }
    break;
    ...
    case COMM_GET_DECODED_BALANCE: {
        ...
        buffer_append_int32(send_buffer, (int32_t)(app_balance_get_pitch_angle() * 1000000.0),
                            &ind);
        ...
        buffer_append_int32(send_buffer, (int32_t)(app_balance_get_motor_current() * 1000000.0),
                            &ind);
    ...
    case COMM_GET_VALUES_SETUP_SELECTIVE: {
        ...
        if (mask & ((uint32_t)1 << 21))
        {
            buffer_append_uint32(send_buffer, chVTGetSystemTimeX() / (CH_CFG_ST_FREQUENCY / 1000),
                                 &ind);
        }
    ...
    case COMM_SET_MCCONF_TEMP_SETUP: {
        ...
        *mcconf = *mc_interface_get_configuration();
        ...
        {
            const float fact = ((mcconf->si_motor_poles / 2.0) * 60.0 * mcconf->si_gear_ratio) /
...
static THD_FUNCTION(blocking_thread, arg)
{
    ...
    for (;;)
    {
        ...
        case COMM_DETECT_MOTOR_PARAM: {
            ...
            if (!conf_general_detect_motor_param(detect_current, detect_min_rpm, detect_low_duty,
                                                 &detect_cycle_int_limit, &detect_coupling_k,
        ...
        case COMM_DETECT_MOTOR_FLUX_LINKAGE: {
            ...
            float linkage;
            bool res =
                conf_general_measure_flux_linkage(current, duty, min_rpm, resistance, &linkage);
        ...
        case COMM_DETECT_MOTOR_FLUX_LINKAGE_OPENLOOP: {
            ...
            bool res = conf_general_measure_flux_linkage_openloop(
                current, duty, erpm_per_sec, resistance, inductance, &linkage, &linkage_undriven,
                &undriven_samples);
        ...
        case COMM_DETECT_APPLY_ALL_FOC: {
            ...
            int res = conf_general_detect_apply_all_foc_can(
                detect_can, max_power_loss, min_current_in, max_current_in, openloop_rpm, sl_erpm);
