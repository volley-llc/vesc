...
#define MCCONF_L_MAX_ABS_CURRENT                                                                   \
    130.0 // The maximum absolute current above which a fault is generated
#endif
...
#define MCCONF_L_SLOW_ABS_OVERCURRENT                                                              \
    false // Use the filtered (and hence slower) current for the overcurrent fault detection
#endif
...
#define MCCONF_L_CURR_MAX_RPM_FBRAKE_CC                                                            \
    1500 // Maximum electrical RPM to use full brake at with current control
#endif
...
#define MCCONF_L_LIM_TEMP_ACCEL_DEC                                                                \
    0.15 // Decrease temperature limits this much during acceleration
#endif
...
#define MCCONF_CC_STARTUP_BOOST_DUTY                                                               \
    0.01 // The lowest duty cycle to use in current control mode (has to be > MCPWM_MIN_DUTY_CYCLE)
#endif
...
#define MCCONF_SL_PHASE_ADVANCE_AT_BR                                                              \
    0.8 // Flux integrator limit percentage at MCPWM_CYCLE_INT_START_RPM_BR ERPM
#endif
...
#define MCCONF_SL_MAX_FB_CURR_DIR_CHANGE                                                           \
    10.0 // Maximum current during full brake during which a direction change is allowed
#endif
...
#define MCCONF_FOC_OPENLOOP_RPM                                                                    \
    1500.0 // Openloop RPM (sensorless low speed or when finding index pulse)
#endif
...
#define MCCONF_FOC_D_GAIN_SCALE_START                                                              \
    0.9 // Start reducing D axis current controller gain at this modulation
#endif
...
#define MCCONF_FOC_HFI_OBS_OVR_SEC                                                                 \
    0.001 // Continue using observer for this long when entering HFI speed
#endif
...
#define MCCONF_FOC_FW_Q_CURRENT_FACTOR                                                             \
    0.02 // Factor of the FW-current to feed to the Q-axis to slow motor down when setting 0 current
#endif
