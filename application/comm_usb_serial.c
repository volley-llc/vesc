...
static const uint8_t vcom_configuration_descriptor_data[67] = {
    ...
    USB_DESC_ENDPOINT(USBD2_INTERRUPT_REQUEST_EP | 0x80, 0x03, /* bmAttributes (Interrupt). */
 ...
 */
static const USBConfig usbcfg = {usb_event, get_descriptor, sduRequestsHook, NULL};

/*
 * Serial over USB driver configuration.
 */
const SerialUSBConfig serusbcfg = {&USBD1, USBD2_DATA_REQUEST_EP, USBD2_DATA_AVAILABLE_EP,
                                   USBD2_INTERRUPT_REQUEST_EP};

void comm_usb_serial_init(void)
{
    palSetPadMode(GPIOA, 11,
                  PAL_MODE_ALTERNATE(GPIO_AF_OTG_FS) | PAL_STM32_OTYPE_PUSHPULL |
